...
import presenttoglass.controllers.IO;
import presenttoglass.controllers.Net;
import presenttoglass.controllers.OS;
import presenttoglass.controllers.Server;
import presenttoglass.controllers.presenters.mac.Keynote;
import presenttoglass.controllers.presenters.windows.LibreOffice;
import presenttoglass.controllers.presenters.windows.Prezi;
import presenttoglass.controllers.presenters.windows.PowerPoint;
...
public class Nav {
    ...
    public void setSoftware(int num){
        ...
        switch(num){
            case(1):
                presenttoglass.Main.presenter = new Keynote();
                break;
            case(2):
                presenttoglass.Main.presenter = new LibreOffice();
                break;
            case(3):
                presenttoglass.Main.presenter = new Prezi();
                break;
            default:
                presenttoglass.Main.presenter = OS.isMac() ? new presenttoglass.controllers.presenters.mac.PowerPoint() : new PowerPoint();
                break;
        }
    }
                    ...
                    @Override public void handle(MouseEvent e) {
                        if(IO.isSaved()) {
                            if(Main.presenter.isPresenting){
                                ...
                                presenttoglass.Main.openSplash();
                            }
                        } else {
